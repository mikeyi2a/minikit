...
export function DemoSlider({ defaultValue, className, ...props }: DemoSliderProps) {
  const [value, setValue] = React.useState(defaultValue);
  return <Slider {...props} value={value} onValueChange={setValue} className={className} />;
}
...
export function DemoDualSlider({ defaultValue, className, ...props }: DemoDualSliderProps) {
  const [value, setValue] = React.useState(defaultValue);
  return <DualSlider {...props} value={value} onValueChange={setValue} className={className} />;
}
