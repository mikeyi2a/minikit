  ...
  return (
    <div className="relative h-[360px] rounded-xl border overflow-hidden" style={{ borderColor: "var(--mk-border)" }}>
      ...
      <Panel mode="floating" title="Adjustments" defaultPosition={{ x: 16, y: 16 }} width={200}>
        <Slider label="Opacity" value={opacity} onValueChange={setOpacity} min={0} max={100} className="" />
        <Slider label="Blur" value={blur} onValueChange={setBlur} min={0} max={20} className="" />
      </Panel>
  ...
  return (
    <div className="max-w-xs flex flex-col gap-3">
      <FieldGroup label="Brush size" hint="Drag">
        <Slider label="" value={brush} onValueChange={setBrush} min={1} max={64} showValue className="" />
      </FieldGroup>
